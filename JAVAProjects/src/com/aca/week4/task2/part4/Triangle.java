...
public class Triangle {
    ...
    public Triangle(final Triangle triangle) {
        // If we'll have another child of Point will not work, because the fields are Point
        // instead of ImmutablePoint, but deep copy functionality we have in ImmutablePoint class not in Point.
